...
public class Arduino_OSC_IO_Bridge_Test_Host extends PApplet {
...
public void mouseReleased() { //set trigger int back to [0] on mousebutton release
  if (mouseButton == LEFT) {
  LClickColor = 255;  
  //**debug printout
...
public void oscEvent(OscMessage theOscMessage) {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Arduino_OSC_IO_Bridge_Test_Host" };
    if (passedArgs != null) {
